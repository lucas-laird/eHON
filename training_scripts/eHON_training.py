...
def train_epochs(model, train_loader, test_loader, optimizer, num_epochs = 10, scheduler = None, log_iter = 10, device = 'cuda:0', log_dir = "eHON_checkpoints/", loaded_checkpoint = None):
